...
Võistlusala on jagatud kaheks erinevaks tsooniks.
...
. Mänguala sisaldab mänguväljakut ja lisatsooni robotitele liikumiseks.
Lisatsoon mänguväljaku ümber on vähemalt 400 mm lai.
Mänguala pikkus on vähemalt 5400 mm ja laius vähemalt 3900 mm.
...
Mänguala välispiiril on vähemalt 100 mm kõrgused valged seinad.

==== Mänguväljaku märgistus

Väljaku märgistust vaata <<image_court_markings>> ja mänguala mõõtmeid vaata <<image_court_dimensions>>.
...
[#being_in_playing_area]
== Mängualas viibimine

=== Robotid

. Mängu ajal võivad mängualas viibida ainult selles mängus võistlevad robotid.

=== Kõik inimesed

. Mängude ajal ei tohi mängualas liikujate riietuses olla väljaku ega korvide värve (v.a must).

=== Võistkonna liikmed

. Mängu kestel on lubatud mängualas viibida ainult võistlevate võistkondade liikmetel.
. Käimasoleva mängu ajal on roboti käivitamiseks lubatud mänguala sisse ulatuda (ilma mängualasse astumata) mõlemast võistkonnast ainult ühel liikmel.
Pärast roboti käivitamist tuleb mängualast lahkuda.
. Kui mänguvoor on peatatud, on kummastki võistkonnast lubatud mängualas viibida kuni kahel liikmel.
. Mänguvoorude vahelisel ajal on lubatud mängualas viibida kogu võistkonnal.
. Mängude vahelisel ajal on lubatud mängualas viibida ainult algava mängu võistkondadel.

=== Kohtunikud

. Kohtunikel on lubatud mängualas viibida igal ajal, välja arvatud käimasoleva mänguvooru ajal.

=== Korraldajad

. Korraldajatel on lubatud mängusalas viibida ainult voorude ja mängude vahelisel ajal.

=== Ülejäänud inimesed

. Ülejäänutel inimestel ei ole lubatud mängualas viibida.
...
. Audis pall - vähemalt korra mänguväljakut piiravast mustast joonest pealtvaates täielikult väljaspool käinud pall.
...
* roboti võistkonnaliige rikub mängualas viibimise reegleid (vaata <<being_in_playing_area>>);
* roboti võistkonnaliige liigutab mänguvooru ajal mängualas olevaid palle.
...
* Tagab, et pealtvaatajad ei sisene mängualasse (vaata <<being_in_playing_area>>).
