...
Pallid on rohelised mini squashi pallid massiga ligikaudu 24 g ja diameetriga ligikaudu 40 mm.
...
Robotid peavad suutma vastu võtta ja vastata erinevate ID-dega käskudele.
...
* 17 - 32 robotiha mängitakse 5 vooru.
