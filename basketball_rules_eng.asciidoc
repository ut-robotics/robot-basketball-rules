...
The competition area is divided into two different zones.
...
The extra zone around the playing court is at least 400 mm wide.
Playing area is at least 5400 mm long and at least 3900 mm wide.
...
Playing area is surrounded by white walls which are at least 100 mm high.

==== Court markings

Court markings are shown in <<image_court_markings>> and playing area dimensions in <<image_court_dimensions>>.
...
== Being in the playing area

=== Robots

. During a game, only robots competing in that game can be in the playing area.

=== All people

. During the games, everyone in the playing area must wear clothes which do not have the same colours that are present in the playing area or baskets (except for black).

=== Team members

. Only team members of the competing robots can be in the playing area during a game.
. During an active game, only one team member from each team is allowed to reach into playing area (without stepping into it) for starting the robot.
The team member has to leave the playing area after starting the robot.
. When a game round is stopped, up to two team members from each team can be in the playing area.
. Entire team is allowed in the playing area between game rounds.
. Only teams of the game about to start are allowed in the playing area between the games.

=== Referees

. Referees can be in the playing area during the entire competition, except during the active game round.

=== Organisers

. Organisers are only allowed to be in the playing area between games and game rounds.

=== Other people

. Other people are not allowed in the playing area.
...
* robot's team member breaks the rules of being in the playing area (see <<being_in_playing_area>>);
* robot's team member moves the balls in the playing area during game's round.
...
* Ensures that the spectators do not enter the playing area (see <<being_in_playing_area>>).
